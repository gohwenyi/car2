...
function onResults(results) {
  ...
  canvasCtx.fillText("3 4001-6000", 375, 200);
  canvasCtx.fillText("4 6001-8000", 525, 200);
  canvasCtx.fillText("5 8001-10000", 675, 200);
  ...
  if (cx > 50 && cx < 150 && cy > 50 && cy<100 && counter==1) 
  {
    ...
    if (age>99){
	  ...
	  cv.rectangle(src, new cv.Point(50, 50), new cv.Point(250, 100), [0, 255, 0, 255], -1); //RGBA - A for alpha
  }else
  {
